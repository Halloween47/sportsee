...
export class DataService {
   ...
   async getAllDatas() {
      const response = await axios.get('http://localhost:3000/datasMocked.json');
  console.log(response.data);  
   ...
   async getActivity(userId){
         ...
         const filteredActivities = response.data.activity.filter(activity => activity.userId === userId);
