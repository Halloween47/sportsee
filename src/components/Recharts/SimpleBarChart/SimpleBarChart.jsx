...
const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)', padding: '10px', borderRadius: '5px', border: '1px solid #ccc' }}>
    ...
    <ResponsiveContainer width="100%" height="100%" style={{ backgroundColor: '#FBFBFB', borderRadius: '10px',padding: '50px' }}>
      ...
      Activité quotidienne
        ...
        >
          ...
          <Bar name="Poids (kg)" dataKey="kilogram" fill="#282D30" legendType="circle" activeBar={<Rectangle fill="pink" stroke="blue" />} radius={[20, 20, 0, 0]} maxBarSize={10} barC={20}/>
